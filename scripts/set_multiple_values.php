...
send_float(vzx_udp_channels\channel_2, 5.5, $remote_ip, $port);

// send a float3 value
send_float3(vzx_udp_channels\channel_2, 0.0, 0.0, 0.0, $remote_ip, $port);

// send a float4 value
send_float4(vzx_udp_channels\channel_2, 1.0, 1.0, 1.0, 1.0, $remote_ip, $port);
